...
**One-sentence answer:** use `useEffect` for most side effects; use `useLayoutEffect` only when you need to read or change layout _before_ the user sees the screen.
