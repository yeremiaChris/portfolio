...
export const INTRO_EXIT_MS = 450;
export const INTRO_VISIBILITY_EVENT = "intro:visibility";

export const INTRO_BOOTSTRAP_SCRIPT = `try{if(sessionStorage.getItem("${INTRO_STORAGE_KEY}")==="${INTRO_SEEN_VALUE}")document.documentElement.dataset.intro="seen"}catch(e){}`;
